...
incorporates only virtual drift (long dry periods in the summer).
\begin{table*}
\def\arraystretch{0.9}
\footnotesize
\centering
...
\subfloat[Bootstrapped samples for detecting real drift.]{
\label{tab:drifttype}
...
\par\vspace{5 pt}
\subfloat[Permutated bootstrapped samples for detecting real drift.]{
\begin{tabular}{l|ccccccc}
\textit{Dataset} & KNN\textsubscript{S-100}&KNN\textsubscript{S-500}&KNN\textsubscript{S-1000}&KNN\textsubscript{S-5000}&KNN\textsubscript{S-10000}&KNN&Concluded drift type\\\hline
\rule{0pt}{8pt}
