function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy] = OSELM2(TrainingData_File, TestingData_File, Elm_Type, nHiddenNeurons, ActivationFunction, N0, Block)
...
T=train_data(:,37)-1; P=train_data(:,1:36);

TV.T=test_data(:,37)-1; TV.P=test_data(:,1:36);
