...
Hyperparameters::Hyperparameters(const int& numTrees, const int& numTests, const int& maxDepth, const int& counterThreshold)
{
    this->numTrees = numTrees;
    this->numRandomTests = numTests;
    this->maxDepth = maxDepth;
    this->counterThreshold = counterThreshold;
}

Hyperparameters::Hyperparameters(const string& confFile, const string& trainFeaturesFileName, 
		const string& trainLabelsFileName, const string& testFeaturesFileName, const string& testLabelsFileName,
		int numTrees, int numTests, int maxDepth, int counterThreshold)
{
	this->init(confFile);
    trainData = trainFeaturesFileName;
    trainLabels = trainLabelsFileName;
    testData = testFeaturesFileName;
    testLabels = testLabelsFileName;
    this->numTrees = numTrees;
    this->numRandomTests = numTests;
    this->maxDepth = maxDepth;
    this->counterThreshold = counterThreshold;
...
void Hyperparameters::init(const string& confFile){
