...
class OnlineTree: public Classifier {
 public:
    ...
    virtual int getComplexityNumParamMetric();
...
class OnlineRF: public Classifier {
 public:
    ...
    //OnlineRF(const int& numTrees, const int& numRandomTests, const int& maxDepth, const int& counterThreshold, const int& numClasses, const int& numFeatures, const VectorXd& minFeatRange, const VectorXd& maxFeatRange);
    ~OnlineRF();
