function [resModels, numMarginVectors, numErrorVectors] = fitISVM2(features, labels, models, numOfClasses, KTYPE, CVar, KSCALE, maxReserveVectors)
...
for classIdx=1:size(models, 2)
    ...
    if (models{classIdx}.isEmpty)
        if sameLabelSamples > 0
            ...
            svmtrain(features(:,classIndices(1):end),localLabels(classIndices(1):end), CVar, KTYPE, KSCALE);
